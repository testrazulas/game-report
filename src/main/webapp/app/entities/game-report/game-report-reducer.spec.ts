...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMEREPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAMEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMEREPORT actions', async () => {
      const expectedActions = [
        {
